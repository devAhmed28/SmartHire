        ...
        public RegisterCommandValidator()
        {
            ...
            When(x => x.AccountType == AccountType.Candidate, () =>
            {
                RuleFor(x => x.Candidate)
                    .NotNull()
                    .WithMessage("Candidate details are required for Candidate registration");
            ...
            When(x => x.AccountType == AccountType.Company, () =>
            {
                RuleFor(x => x.Company)
                    .NotNull()
                    .WithMessage("Company details are required for Company registration");
                ...
                When(x => x.Company != null, () =>
                {
                    ...
                    RuleFor(x => x.Company!.CompanySize)
                        .IsInEnum()
                        .WithMessage("Invalid company size. Must be Startup, Small, Medium, Large, or Enterprise");
                });
            });
        }
    }
